...
import type { Product, Customer, Invoice, CashFlowTransaction, Supplier, Category, Purchase, Quote, Order, Delivery, InventoryCheck } from '../types';
...
export const initialInventoryChecks: InventoryCheck[] = [];
