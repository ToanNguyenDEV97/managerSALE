...
import { Button } from '../../common/Button'; // Component chuẩn mới
import Pagination from '../../common/Pagination';
import ConfirmationModal from '../../common/ConfirmationModal';
import CustomerModal from './CustomerModal';
import { useCustomers, useDeleteCustomer } from '../../../hooks/useCustomers'; // Đảm bảo hook này tồn tại
...
const CustomersPage: React.FC = () => {
    ...
    // Fetch Data an toàn hơn
    const { data: customersData, isLoading } = useCustomers(page, 10, searchTerm);
    ...
    // Helper lấy chữ cái đầu tên (Tránh lỗi nếu tên null)
                                    ...
                                    <tr key={c.id || Math.random()} className="hover:bg-slate-50 transition-colors group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">
                                                ...
                                                <div>
                                                    <div className="font-medium text-slate-900">{c.name || 'Không có tên'}</div>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col">
                                                ...
                                                {c.email && <span className="text-xs text-slate-400 mt-1">{c.email}</span>}
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
